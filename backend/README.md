...
- **RESTful API** - Повнофункціональний API з автентифікацією JWT
- **Гнучка архітектура** - Підтримка PostgreSQL та SQLite
- **Аналітика** - Детальна аналітика роботи з електронною поштою
